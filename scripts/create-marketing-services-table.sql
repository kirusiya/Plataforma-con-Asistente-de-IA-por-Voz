...
('Gestión de Redes Sociales', 'gestion-redes-sociales', 'Creamos y ejecutamos estrategias de contenido para tus redes sociales (Facebook, Instagram, LinkedIn, Twitter, TikTok). Incluye creación de posts, gestión de comunidades, campañas de anuncios pagados y análisis de rendimiento para aumentar el engagement y la conversión.', 850.00, '/placeholder.svg?height=400&width=600', true),
